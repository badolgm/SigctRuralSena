"""
Django settings para SIGC&T-Rural v2.0
...
# Security
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-sigct-rural-dev-key')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'sigct_db'),
        'USER': os.getenv('DB_USER', 'sigct_user'),
...
INFLUX_ORG = os.getenv('INFLUX_ORG', 'sigct')
